...
const Demo: React.FC = () => {
  useEffect(() => {
    ...
    script.src = "https://go.screenpal.com/consumption/player_appearance/cOfUlunOdQ5/1.777778";
    script.async = true;
          ...
          <div className="rounded-[24px] md:rounded-[32px] overflow-hidden bg-gray-900 relative border border-gray-100">
            ...
            >
              <iframe 
                ...
                scrolling="no" 
                src="https://go.screenpal.com/player/cOfUlunOdQ5?ff=1&ahc=1&dcc=1&tl=1&bg=transparent&share=1&download=1&embed=1&cl=1" 
